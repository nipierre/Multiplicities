...
void create_kin_plots()
{
  for(int i=0; i<5; i++)
  {
    ...
    fKinematicsMC2[i][8] = new TH1F(Form("#theta %s",trigname[i].c_str()), Form("#theta %s",trigname[i].c_str()), 100, 0, 0.025);
    ...
    fKinematicsMC1[i][8] = new TH1F(Form("#theta Ratio %s",trigname[i].c_str()), Form("#theta Ratio %s",trigname[i].c_str()), 100, 0, 0.025);
  ...
  for(int i=0; i<7; i++)
  {
    ...
    l2[8][i] = new TLine(0,0.4+i*0.2,0.1,0.4+i*0.2);
