...
mom06 = [9.5,10.5,11.5,12.5,14.,16.,18.,20.5,23.5,26.,28.5,32.5,37.5,45.]
mom11 = [10.5,11.5,12.5,14.,16.,18.,20.5,23.5,26.,28.5,32.5,37.5,45.]
mom16 = [4.,6.,8.5,11.,12.5,14.,16.,18.5,20.5,23.5,26.,28.5,32.5,37.5,45.]
...
for i in 1:2
    ...
    plot(mom06, pip2pip06[i], lw=3,
                              ...
                              ylims = (0,1.1),
                              xlabel = L"$p_h (GeV/c)$",
                              ylabel = L"$\epsilon(\pi^+ \rightarrow \pi^+)$",
                              label = "2006")
    ...
    plot(mom06, pip2kp06[i], lw=3,
                              ...
                              ylims = (0,1.1),
                              xlabel = L"$p_h (GeV/c)$",
                              ylabel = L"$\epsilon(\pi^+ \rightarrow K^+)$",
                              label = "2006")
    ...
    plot(mom06, pip2pp06[i], lw=3,
                              ...
                              ylims = (0,1.1),
                              xlabel = L"$p_h (GeV/c)$",
                              ylabel = L"$\epsilon(\pi^+ \rightarrow p)$",
                              label = "2006")
    ...
    plot(mom06, pim2pm06[i], lw=3,
                              ...
                              ylims = (0,1.1),
                              xlabel = L"$p_h (GeV/c)$",
                              ylabel = L"$\epsilon(\pi^- \rightarrow \bar p)$",
                              label = "2006")
    ...
    plot(mom06, kp2pip06[i], lw=3,
                              ...
                              ylims = (0,1.1),
                              xlabel = L"$p_h (GeV/c)$",
                              ylabel = L"$\epsilon(K^+ \rightarrow \pi^+)$",
                              label = "2006")
    ...
    plot(mom06, kp2kp06[i], lw=3,
                              ...
                              ylims = (0,1.1),
                              xlabel = L"$p_h (GeV/c)$",
                              ylabel = L"$\epsilon(K^+ \rightarrow K^+)$",
                              label = "2006")
    ...
    plot(mom06, kp2pp06[i], lw=3,
                              ...
                              ylims = (0,1.1),
                              xlabel = L"$p_h (GeV/c)$",
                              ylabel = L"$\epsilon(K^+ \rightarrow p)$",
                              label = "2006")
    ...
    plot(mom06, km2pm06[i], lw=3,
                              ...
                              ylims = (0,1.1),
                              xlabel = L"$p_h (GeV/c)$",
                              ylabel = L"$\epsilon(K^- \rightarrow \bar p)$",
                              label = "2006")
    ...
    plot(mom06, pp2pip06[i], lw=3,
                              ...
                              ylims = (0,1.1),
                              xlabel = L"$p_h (GeV/c)$",
                              ylabel = L"$\epsilon(p \rightarrow \pi^+)$",
                              label = "2006")
    ...
    plot(mom06, pp2kp06[i], lw=3,
                              ...
                              ylims = (0,1.1),
                              xlabel = L"$p_h (GeV/c)$",
                              ylabel = L"$\epsilon(p \rightarrow K^+)$",
                              label = "2006")
    ...
    plot(mom06, pp2pp06[i], lw=3,
                              ...
                              ylims = (0,1.1),
                              xlabel = L"$p_h (GeV/c)$",
                              ylabel = L"$\epsilon(p \rightarrow p)$",
                              label = "2006")
    ...
    plot(mom06, pm2pim06[i], lw=3,
                              ...
                              ylims = (0,1.1),
                              xlabel = L"$p_h (GeV/c)$",
                              ylabel = L"$\epsilon(\bar p \rightarrow \pi^-)$",
                              label = "2006")
    ...
    plot(mom06, pm2km06[i], lw=3,
                              ...
                              ylims = (0,1.1),
                              xlabel = L"$p_h (GeV/c)$",
                              ylabel = L"$\epsilon(\bar p \rightarrow K^-)$",
                              label = "2006")
    ...
    plot(mom06, pm2pm06[i], lw=3,
                              ...
                              ylims = (0,1.1),
                              xlabel = L"$p_h (GeV/c)$",
                              ylabel = L"$\epsilon(\bar p \rightarrow \bar p)$",
                              label = "2006")
