...
void create_kin_plots()
{
  ...
  fHM04 = new TH2F("HM04", "HM04", 100, -120, 120, 100, -60, 60);
  fHM05 = new TH2F("HM05", "HM05", 100, -250, 250, 100, -100, 100);
  fHL04 = new TH2F("HL04", "HL04", 100, -120, 120, 100, -60, 60);
  fHL05 = new TH2F("HL05", "HL05", 100, -250, 250, 100, -100, 100);
  fHO03 = new TH2F("HO03", "HO03", 100, -120, 120, 100, -60, 60);
  fHO04 = new TH2F("HO04", "HO04", 100, -250, 250, 100, -100, 100);
  fHG01 = new TH2F("HG01", "HG01", 100, -120, 120, 100, -60, 60);
  fHG02 = new TH2F("HG02", "HG02", 100, -250, 250, 100, -100, 100);
