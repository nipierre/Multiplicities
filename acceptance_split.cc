...
void save_kin_plots()
{
  ...
  // MIDDLE
  TLine* M04[8];
  M04[0] = new TLine(0,-24.1719-4*(2.1-.1)+.1,120,-24.1719-4*(2.1-.1)+.1);
  M04[1] = new TLine(0,-41.5719-4*(2.5-.1)+.1+7*(2.5-.1)+2.5,0,-24.1719-4*(2.1-.1)+.1);
  M04[2] = new TLine(0,-41.5719-4*(2.5-.1)+.1+7*(2.5-.1)+2.5,120,-41.5719-4*(2.5-.1)+.1+7*(2.5-.1)+2.5);
  M04[3] = new TLine(120,-41.5719-4*(2.5-.1)+.1+7*(2.5-.1)+2.5,120,-24.1719-4*(2.1-.1)+.1);
