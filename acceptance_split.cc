...
void create_kin_plots()
{
  ...
  fHL04x1D = new TH1F("HL04X1x", "HL04X1x", 1000, 0, 190);
  fHL05x1D = new TH1F("HL05X1x", "HL05X1x", 1000, 0, 240);
  fHL04MCx1D = new TH1F("HL04MCX1x", "HL04MCX1x", 1000, 0, 190);
  fHL05MCx1D = new TH1F("HL05MCX1x", "HL05MCX1x", 1000, 0, 240);
...
void save_kin_plots()
{
  ...
  for(int i=0; i<8; i++)
  {
    ...
    l1[i] = new TLine(detectpos-subdetsize+i*(2.2-.1),0,detectpos-subdetsize+i*(2.2-.1),4500);
    l2[i] = new TLine(detectpos-subdetsize+i*(2.2-.1)+2.2,0,detectpos-subdetsize+i*(2.2-.1)+2.2,4500);
    l1[i]->Draw("SAME");
    l2[i]->Draw("SAME");
  }
  for(int i=0; i<8; i++)
  {
    ...
    l3[i] = new TLine(detectpos-subdetsize+i*(3.2-.3),0,detectpos-subdetsize+i*(3.2-.3),4500);
    l4[i] = new TLine(detectpos-subdetsize+i*(3.2-.3)+3.2,0,detectpos-subdetsize+i*(3.2-.3)+3.2,4500);
    l3[i]->Draw("SAME");
    l4[i]->Draw("SAME");
  }
  for(int i=0; i<8; i++)
  {
    ...
    l5[i] = new TLine(detectpos-subdetsize+i*(4.7-.1),0,detectpos-subdetsize+i*(4.7-.1),4500);
    l6[i] = new TLine(detectpos-subdetsize+i*(4.7-.1)+4.7,0,detectpos-subdetsize+i*(4.7-.1)+4.7,4500);
    l5[i]->Draw("SAME");
    l6[i]->Draw("SAME");
  }
  for(int i=0; i<8; i++)
  {
    ...
    l7[i] = new TLine(detectpos-subdetsize+i*(6.7-.3),0,detectpos-subdetsize+i*(6.7-.3),4500);
    l8[i] = new TLine(detectpos-subdetsize+i*(6.7-.3)+6.7,0,detectpos-subdetsize+i*(6.7-.3)+6.7,4500);
    l7[i]->Draw("SAME");
    l8[i]->Draw("SAME");
  }
  c26.Update();
  ...
  for(int i=0; i<8; i++)
  {
    ...
    l11[i] = new TLine(detectpos-subdetsize+i*(2.7-.1),0,detectpos-subdetsize+i*(2.7-.1),4500);
    l12[i] = new TLine(detectpos-subdetsize+i*(2.7-.1)+2.7,0,detectpos-subdetsize+i*(2.7-.1)+2.7,4500);
    l11[i]->Draw("SAME");
    l12[i]->Draw("SAME");
  }
  for(int i=0; i<8; i++)
  {
    ...
    l13[i] = new TLine(detectpos-subdetsize+i*(4.2-.3),0,detectpos-subdetsize+i*(4.2-.3),4500);
    l14[i] = new TLine(detectpos-subdetsize+i*(4.2-.3)+4.2,0,detectpos-subdetsize+i*(4.2-.3)+4.2,4500);
    l13[i]->Draw("SAME");
    l14[i]->Draw("SAME");
  }
  for(int i=0; i<8; i++)
  {
    ...
    l15[i] = new TLine(detectpos-subdetsize+i*(6.2-.1),0,detectpos-subdetsize+i*(6.2-.1),4500);
    l16[i] = new TLine(detectpos-subdetsize+i*(6.2-.1)+6.2,0,detectpos-subdetsize+i*(6.2-.1)+6.2,4500);
    l15[i]->Draw("SAME");
    l16[i]->Draw("SAME");
  }
  for(int i=0; i<8; i++)
  {
    ...
    l17[i] = new TLine(detectpos-subdetsize+i*(8.7-.3),0,detectpos-subdetsize+i*(8.7-.3),4500);
    l18[i] = new TLine(detectpos-subdetsize+i*(8.7-.3)+8.7,0,detectpos-subdetsize+i*(8.7-.3)+8.7,4500);
    l17[i]->Draw("SAME");
    l18[i]->Draw("SAME");
  }
  c27.Update();
