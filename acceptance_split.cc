...
void create_kin_plots()
{
  ...
  fHM04 = new TH2F("HM04X1", "HM04X1", 100, -120, 120, 100, -60, 60);
  fHM05 = new TH2F("HM05X1", "HM05X1", 100, -250, 250, 100, -100, 100);
  fHL04 = new TH2F("HL04X1", "HL04X1", 100, -120, 120, 100, -60, 60);
  fHL05 = new TH2F("HL05X1", "HL05X1", 100, -250, 250, 100, -100, 100);
  fHO03 = new TH2F("HO03Y1", "HO03Y1", 100, -120, 120, 100, -60, 60);
  fHO04 = new TH2F("HO04Y1", "HO04Y1", 100, -250, 250, 100, -100, 100);
  fHG01 = new TH2F("HG01Y1", "HG01Y1", 100, -120, 120, 100, -60, 60);
  fHG021 = new TH2F("HG02Y1", "HG02Y1", 100, -250, 250, 100, -100, 100);
  fHG022 = new TH2F("HG02Y2", "HG02Y2", 100, -250, 250, 100, -100, 100);  
