...
void save_kin_plots()
{
  ...
  gPad->SetLogz();
  TF1 *fe = new TF1("fe","th_cherenkov_e(x)",0,60);
  fe->SetLineColor(10);
  fe->SetLineStyle(9);
  fe->Draw("SAME");
  TF1 *fmu = new TF1("fmu","th_cherenkov_mu(x)",0,60);
  fmu->SetLineColor(10);
  fmu->SetLineStyle(9);
  fmu->Draw("SAME");
  TF1 *fpi = new TF1("fpi","th_cherenkov_pi(x)",0,60);
  fpi->SetLineColor(10);
  fpi->SetLineStyle(9);
  fpi->Draw("SAME");
  TF1 *fk = new TF1("fk","th_cherenkov_k(x)",0,60);
  fk->SetLineColor(10);
  fk->SetLineStyle(9);
  fk->Draw("SAME");
  TF1 *fp = new TF1("fp","th_cherenkov_p(x)",0,60);
  fp->SetLineColor(10);
  fp->SetLineStyle(9);
  fp->Draw("SAME");
  c12.Update();
