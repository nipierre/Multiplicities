...
vector<Double_t> xd, xh, xd_MC, xh_MC;
vector<Double_t> yd, yh, yd_MC, yh_MC;
vector<Double_t> zh, zh_MC;
vector<Double_t> zVTXd, zVTXh, zVTXd_MC, zVTXh_MC;
vector<Int_t> trigd, trigh, trigd_MC, trigh_MC;
vector<Double_t> nud, nuh, nud_MC, nuh_MC;
vector<Int_t> mu_charged, mu_chargeh, mu_charged_MC, mu_chargeh_MC;
vector<Double_t> eVTX_MC;
vector<Double_t> Wd, Wh, Wd_MC, Wh_MC;
vector<Double_t> phh, ph_MC;
