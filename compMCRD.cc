...
void create_kin_plots()
{
  for(int i=0; i<4; i++)
  {
    ...
    fKinematicsRD[i][6] = new TH1F(Form("#Phi_h %s",trigname[i].c_str()), Form("#Phi_h %s",trigname[i].c_str()), 100, 0, 3);
    ...
    fKinematicsMC[i][6] = new TH1F(Form("#Phi_h MC %s",trigname[i].c_str()), Form("#Phi_h MC %s",trigname[i].c_str()), 100, 0, 3);
