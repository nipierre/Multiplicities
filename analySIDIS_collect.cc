...
int main(int argc, char **argv)
{
  ...
  for(int i=0; i<9; i++)
  {
    ...
    rk_y_err.push_back(sqrt((MultiplicitiesSum[1][0][1]+MultiplicitiesSum[0][1][1]*MultiplicitiesSum[1][1][1]/MultiplicitiesSum[0][0][1])/MultiplicitiesSum[0][0][1]));
    rh_y_err.push_back(sqrt((MultiplicitiesSum[1][0][3]+MultiplicitiesSum[0][1][3]*MultiplicitiesSum[1][1][3]/MultiplicitiesSum[0][0][3])/MultiplicitiesSum[0][0][3]));
  }
