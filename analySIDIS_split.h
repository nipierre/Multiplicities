...
Float_t fPplus = 0;
Float_t fPminus = 0;
Float_t fPiplus_true = 0;
Float_t fPiminus_true = 0;
Float_t fKplus_true = 0;
Float_t fKminus_true = 0;
Float_t fPplus_true = 0;
Float_t fPminus_true = 0;
Float_t fPiplus_err = 0;
Float_t fPiminus_err = 0;
Float_t fKplus_err = 0;
Float_t fKminus_err = 0;
Float_t fPplus_err = 0;
Float_t fPminus_err = 0;
Float_t fFilesNumber = 0;
